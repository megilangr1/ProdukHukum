<div>
    ...
    <div class="modal modal-bottom sm:modal-middle" role="dialog">
        <div class="modal-box flex flex-col p-0 sm:w-[70vw] sm:max-w-full">
            <h3 class="text-lg font-bold px-4 py-3">Daftar Organisasi Perangkat Daerah (OPD)</h3>
            <hr class="border-t border-t-slate-300">

            <div class="relative w-full">
                <label class="sr-only" for="filter-search-opd">Cari Data :</label>
                <input type="text" name="filter-search-opd" id="filter-search-opd"
                ...
                <table class="table table-sm table-pin-rows table-pin-cols">
                    <thead>
                        <tr>
                            ...
                            <td class="bg-slate-200">Kode OPD</td>
                            <td class="bg-slate-200">Nama OPD</td>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <th class="text-center">
                                    <button type="button" wire:click="selectOpd('{{ $item->uuid }}')"
